...
using CoreApiTemplate.Models.Common;
using LightInject;
using LightInject.Microsoft.DependencyInjection;
using Microsoft.AspNetCore.Http;
using Microsoft.Extensions.DependencyInjection;

namespace CoreApiTemplate.Api.LightInject
{
    /// <summary>
    ...
    public static class ServiceProviderFactory
    {
        ...
        private static void RegisterServices(this IServiceContainer container)
        {
            ...
            container.RegisterAssembly(
                Load(AppConstants.CoreApiTemplateData),
                ...
                (serviceType, implementationType) =>
                    ...
                    implementationType.Namespace.StartsWith(AppConstants.CoreApiTemplateDataRepositories));

            // Register services.
            container.RegisterAssembly(
                Load(AppConstants.CoreApiTemplateBusiness),
                () => new PerContextLifetime(container.GetInstance<IHttpContextAccessor>()),
                (serviceType, implementationType) =>
                    serviceType.GetTypeInfo().IsInterface &&
                    implementationType.Name.EndsWith(AppConstants.ServiceSuffix) &&
                    implementationType.Namespace.StartsWith(AppConstants.CoreApiTemplateBusinessServices));
        }
